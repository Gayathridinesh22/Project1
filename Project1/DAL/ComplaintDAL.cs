...
namespace Project1.DAL
{
    public class ComplaintDAL
    {
        ...
        {
            string qry = "select  c.date,c.complaintid,c.userid, p.productid,p.productname,u.name, c.complaint, c.status from Product p  INNER JOIN Complaint c  ON p.productid = c.productid INNER JOIN Registration u ON c.userid = u.userid";
